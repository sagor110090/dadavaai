                ...
                <form action="{{url('/sendMail')}}" id="sendMail" onsubmit="sendMail(event)">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <input class="form-control" name="mailto" placeholder="To:" value="{{implode(';', json_decode($draft->mail_to))}}">
                        ...
                        <div class="form-group">
                            <input class="form-control" name="subject" placeholder="Subject:" value="{{$draft->subject}}">
                            <p class="error subject text-center alert alert-danger hidden"></p>
                        </div>
                        <div class="form-group">
                            <textarea id="editor1" name="mailbody" class="form-control" style="height: 300px">{{$draft->mail_body}}</textarea>
                    ...
                    <div class="box-footer">
                        <div class="pull-right">
                            <button type="button" class="btn btn-default" id="updateDraft" data-url="{{url('drafts/'.$draft->id)}}"><i class="fa fa-pencil"></i> Draft</button>
