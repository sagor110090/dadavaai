                    ...
                    <tr id="category{{$category->id}}">
                        ...
                        <td>
                            <div class="table-data-feature">
                                <a href="#" class="edit-category btn btn-warning btn-sm" data-id="{{$category->id}}" data-categoryName="{{$category->categoryName}}" data-images="{{$category->imges}}" >
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                                <label class="control-label col-sm-2" for="categoryName">Image:</label>
                                <div class="col-sm-10">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="modal">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" class="form-control" id="ecategoryImage" name="ecategoryImage"
                                           placeholder="ecategoryImage Here" >
                                </div>
                            </div>
