...
<!-- Mirrored from demo.devitems.com/oneclick-preview/oneclick/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Jul 2019 04:32:29 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>OneClick Home One</title>
					...
					<div class="row">
						<div class="col-lg-3 col-md-3 hidden-sm hidden-xs">
							...
							@foreach ($categories as $category)
									<li><a href="{{URL::to('/productsByCat/'.$category->categoryName)}}"><i class="fa fa-laptop"></i> {{  $category->categoryName  }} <i class="fa fa-angle-right pull-right"></i></a>
										<ul class="megamenu-2 box-shadow">
										
										@foreach ($category->subcategory as $subcategory)
											<li>
												<a class="mega-title bb" href="{{URL::to('/productsByCat/'.$subcategory->subCategoryName )}}"> {{$subcategory->subCategoryName }} </a>
												@foreach ($subcategory->minicategory as $minicategory)
													<a href="{{URL::to('/productsByCat/'.$minicategory->miniCategoryName )}}">{{$minicategory->miniCategoryName}}</a>
												@endforeach
...
<!-- Mirrored from demo.devitems.com/oneclick-preview/oneclick/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Jul 2019 04:34:38 GMT -->
</html>
