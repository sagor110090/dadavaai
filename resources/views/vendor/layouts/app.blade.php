...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
        <a href="{{url('/vproducts')}}" class="logo">
            <!-- mini logo for sidebar mini 50x50 pixels -->
            <span class="logo-mini"><b>D</b>ada</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>DadaVaai</b></span>
        </a>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{url('vproducts')}}"><i class="fa fa-circle-o"></i> Product</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{url('/vorders')}}"><i class="fa fa-circle-o"></i> Order</a></li>
                        {{-- <li><a href="{{url('/vdiscounts')}}"><i class="fa fa-circle-o"></i> Coupon</a></li> --}}
